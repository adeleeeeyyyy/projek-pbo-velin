<x-app-layout>
    <x-slot name="header">
        <h2 class="font-black text-2xl text-gray-800 leading-tight italic tracking-tighter uppercase">
            {{ __('Edit Produk') }}: <span class="text-pale-pink-600 underline decoration-pale-pink-200 decoration-wavy">{{ $product->name }}</span>
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-12 rounded-[3rem] shadow-2xl border border-pale-pink-100 space-y-10 relative overflow-hidden">
                ...
                <form action="{{ route('admin.products.update', $product) }}" method="POST" enctype="multipart/form-data" class="space-y-12">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="space-y-4">
                                ...
                                <x-text-input id="name" name="name" type="text" class="mt-1 block w-full rounded-2xl border-pale-pink-100 focus:border-pale-pink-500 focus:ring-pale-pink-500 transition shadow-inner p-4 text-lg font-bold italic" :value="old('name', $product->name)" required />
                            ...
                            <div class="space-y-4">
                                ...
                                <x-text-input id="sku" name="sku" type="text" class="mt-1 block w-full rounded-2xl border-pale-pink-100 focus:border-pale-pink-500 focus:ring-pale-pink-500 transition shadow-inner p-4 text-lg font-bold italic uppercase" :value="old('sku', $product->sku)" required />
                            ...
                            <div class="space-y-4">
                                ...
                                <textarea id="description" name="description" rows="5" class="mt-1 block w-full rounded-2xl border-pale-pink-100 focus:border-pale-pink-500 focus:ring-pale-pink-500 transition shadow-inner p-4 font-medium italic">{{ old('description', $product->description) }}</textarea>
                        ...
                        <div class="space-y-8">
                            ...
                            <div class="grid grid-cols-2 gap-6">
                                <div class="space-y-4">
                                    ...
                                    <x-text-input id="price" name="price" type="number" step="0.01" class="mt-1 block w-full rounded-2xl border-pale-pink-100 focus:border-pale-pink-500 focus:ring-pale-pink-500 transition shadow-inner p-4 text-xl font-black italic decoration-pale-pink-200 underline" :value="old('price', $product->price)" required />
                                ...
                                <div class="space-y-4">
                                    ...
                                    <x-text-input id="stock" name="stock" type="number" class="mt-1 block w-full rounded-2xl border-pale-pink-100 focus:border-pale-pink-500 focus:ring-pale-pink-500 transition shadow-inner p-4 text-xl font-black italic" :value="old('stock', $product->stock)" required />
                            ...
                            <div class="space-y-6">
                                ...
                                @if($product->images && count($product->images) > 0)
                                    <div class="grid grid-cols-4 gap-4 mb-6">
                                        @foreach($product->images as $image)
                                            <div class="aspect-square rounded-2xl overflow-hidden border-2 border-pale-pink-100 shadow-sm relative group">
                                                <img src="{{ asset('storage/products/thumbnail/' . $image) }}" class="w-full h-full object-cover">
                                                <div class="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition flex items-center justify-center">
                                                    <span class="text-white text-[10px] font-black italic uppercase tracking-widest">Foto Lama</span>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                                ...
                                <div class="space-y-4">
                                    <label for="images" class="relative group cursor-pointer block border-4 border-dashed border-pale-pink-100 rounded-[2rem] p-12 text-center hover:border-pale-pink-400 transition-all duration-500 hover:bg-pale-pink-50 group shadow-inner">
                                        <div class="space-y-4">
                                            <div class="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mx-auto shadow-lg group-hover:scale-110 transition duration-500">
                                            ...
                                            <div>
                                                <p class="text-lg font-black text-gray-900 italic">Tambah/Ganti Foto</p>
                                                <p class="text-xs text-gray-400 font-medium italic mt-1">(Input ini akan mengganti/menambah foto saat ini)</p>
                                            </div>
                                        </div>
